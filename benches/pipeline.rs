...
fn bench_extract_markdown(c: &mut Criterion) {
    ...
    for (size, name, kind, bytes) in [
        ...
        ("medium", "code", "code", 50_000),
        ("medium", "footnotes", "footnotes", 50_000),
        ("medium", "math", "math", 50_000),
        ("medium", "media", "media", 50_000),
        ("medium", "tables", "tables", 50_000),
        ("medium", "listing", "listing", 50_000),
