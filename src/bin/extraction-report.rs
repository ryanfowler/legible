...
fn report(
    ...
    println!(
        ...
        counters.logical_attempt_plans,
        counters.physical_attempt_executions,
        counters.deduplicated_attempts,
